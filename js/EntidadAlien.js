...
/**
 * Esta entidad representa las naves alien�genas que quieren invadir la tierra
 */
        ...
        switch (fila) {
            case 0:
                this.constructorBase(
                    ...
                    25,
                    [
                        Sprites.get("../img/alien1a.jpg"),
                        Sprites.get("../img/alien1b.jpg")
                    ],
                    200,
                    xIni,
                    yIni,
            ...
            case 2:
                this.constructorBase(
                    ...
                    25,
                    [
                        Sprites.get("../img/alien2a.jpg"),
                        Sprites.get("../img/alien2b.jpg")
                    ],
                    250,
                    xIni,
                    yIni,
            ...
            default:
                this.constructorBase(
                    ...
                    25,
                    [
                        Sprites.get("../img/alien3a.jpg"),
                        Sprites.get("../img/alien3b.jpg")
                    ],
                    300,
                    xIni,
                    yIni,
